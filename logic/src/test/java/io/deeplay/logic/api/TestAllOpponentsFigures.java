...
public class TestAllOpponentsFigures {
    ...
    public void testCompareAttacksAndPossibilitiesWhite() {
        ChessBoard chessBoard =
                new ChessBoard("r4rk1/1pp1b1pp/p1n1b3/3n1pB1/2B5/1N3N2/PPP2PPP/R4RK1 b - - 7 19");
        ...
        List<Coord> allCoords = BitboardHandler.getAllPossibleMoves(chessBoard, Side.WHITE)
        ...
        */
        ...
        chessBoard = new ChessBoard("4r1k1/1pp4p/p7/B5p1/1PQ5/5P1b/P5PP/3K1R2 b - - 0 1");
        ...
        sideBitboards = FENParser.parseFENToBitboards(chessBoard.getFenNotation());
        ...
        // Возможные ходы
        allCoords = BitboardHandler.getAllPossibleMoves(chessBoard, Side.WHITE)
                .values().stream().map(MoveInfo::getCellTo).collect(Collectors.toList());
    ...
    public void testCompareAttacksAndPossibilitiesBlack() {
        ...
        // Возможные ходы
        List<Coord> allCoords = BitboardHandler.getAllPossibleMoves(chessBoard, Side.BLACK)
                .values().stream().map(MoveInfo::getCellTo).collect(Collectors.toList());
        Set<Coord> uniqueCoords = new HashSet<>(allCoords);
