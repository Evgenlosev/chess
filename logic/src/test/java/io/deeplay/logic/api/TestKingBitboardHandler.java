...
public class TestKingBitboardHandler {
    ...
    public void getKingMovesTest() {
        ...
        assertEquals(expectedMoveInfoSet, BitboardHandler.getKingMoves(FENBoard, new Coord(BitUtils.BitIndex.E1_IDX.ordinal())));

        /*
         * Check possible E1 king's moves after e4e5
         */
        FENBoard = new FENBoard("rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq e6 0 1");
         ...
         */
        FENBoard = new FENBoard("r4rk1/1pp1b1pp/p1n1b3/3n1pB1/2B5/1N3N2/PPP2PPP/R4RK1 b - - 7 19");
        expectedMoveInfoSet = Stream.of(
                ...
                .collect(Collectors.toSet());
        assertEquals(expectedMoveInfoSet, BitboardHandler.getKingMoves(FENBoard, new Coord(BitUtils.BitIndex.G8_IDX.ordinal())));
